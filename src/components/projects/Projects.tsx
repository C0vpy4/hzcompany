    ...
    <div className="font-cygre grid grid-cols-1 sm:grid-cols-2 gap-10">
      ...
      <div className="w-full">
        <div className="relative w-full mx-auto">
          ...
          <a
            href="/products"
            className="block relative mt-2 sm:mt-3 w-full aspect-square overflow-hidden  border border-black dark:border-white hover:border-black dark:hover:border-white transition-colors duration-200 group"
