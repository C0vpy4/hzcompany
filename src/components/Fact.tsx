...
export const Fact = () => {
  ...
  return (
    <div id="fact">
      ...
      >
        <div className="w-full text-center text-black text-[clamp(2rem,7vw,8rem)] font-cygre leading-tight break-words">
          <span>каждый продукт - вера </span>
          <span className="text-neutral-500">в нас,</span>
        </div>
        <div className="w-full text-end text-black text-[clamp(2rem,7vw,8rem)] font-cygre leading-tight break-words">
          в каждого человека по отдельности,
        </div>
        <div className="w-full text-right text-neutral-500 text-[clamp(2rem,7vw,8rem)] font-cygre leading-tight break-words">
