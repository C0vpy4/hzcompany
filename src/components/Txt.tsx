  ...
  return (
    <div>
      <div className="font-cygre min-h-screen flex items-center justify-center flex-col gap-5">
        <motion.div
          className=" text-center justify-start text-black dark:text-white text-[clamp(1.75rem,6vw,6rem)] font-cygre sm:leading-[106.97px]"
        ...
        <motion.div
          className=" text-center justify-start text-black dark:text-white text-[clamp(0.95rem,2.6vw,1rem)] font-cygre leading-none"
        ...
        <motion.div
          className="text-center justify-start text-black dark:text-white text-[clamp(0.95rem,2.6vw,1rem)] font-cygre"
          initial={{ opacity: 0, y: 16 }}
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true, amount: 0.3 }}
